# C++20 replay and queue engineering report

## Result and scope

The optional C++20/pybind11 backend passed exact value **and byte-hash parity** with the Python reference over **85,846,918 source messages in 1,250 stock/day partitions**, under both `retain` and `reset` priority interpretations. Queue parity covers **405 test-day partitions and 604,837,896 virtual-order evaluations**. Both sides are evaluated on every eligible row, covering all directions chosen by the frozen Linear/XGBoost/control predictions.
...
| Workload | Backend | Units | Median kernel seconds | Units/s | Native speedup |
| --- | --- | ---: | ---: | ---: | ---: |
| replay | python | 85,846,918 | 4192.595 | 20,476 | 8.984× |
| replay | native | 85,846,918 | 466.656 | 183,962 | 8.984× |
| queue | python | 7,889,736 | 5.099 | 1,547,230 | 3.571× |
| queue | native | 7,889,736 | 1.428 | 5,525,389 | 3.571× |
